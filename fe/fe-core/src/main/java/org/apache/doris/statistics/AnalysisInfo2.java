...
public abstract class AnalysisInfo2 implements Writable {
    ...
    protected abstract static class Builder<T extends Builder<T>> {
        ...
        public Builder(AnalysisInfo2 analysisInfo) {
    ...
    protected AnalysisInfo2(Builder<?> builder) {
    ...
    public String toString() {
        ...
        sj.add("AnalysisType: " + analysisType.toString());
        sj.add("AnalysisMode: " + analysisMode.toString());
        sj.add("AnalysisMethod: " + analysisMethod.toString());
